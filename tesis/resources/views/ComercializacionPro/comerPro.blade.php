        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('comercializacion.store')}}">
                            @csrf    
                            <div class="form-group row mb-2">
                                <label for="password_confirm" class="col-md-6 col-form-label text-md-right">{{ __('Nombre Comercialización Producto') }}</label>
                                <div class="col-md-6">
                                    <input id="comercializacionPro" type="text" class="form-control has-feedback-left @error('pass_conf') is-invalid @enderror" name="comercializacionPro" required >
