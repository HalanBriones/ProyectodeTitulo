        ...
        <table class="table mt-4" method="GET" action="/usuarios">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td class="scope">{{$comer->nombre_tipo_producto}}</td>
                @if ($_SESSION['nombre_rol'] == 'Administrador')
                <td><a  class="btn btn-dark" href="{{route('comerPro.edit',$comer->idcomercializacion_producto)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
