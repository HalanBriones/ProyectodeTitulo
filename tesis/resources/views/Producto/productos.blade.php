        ...
        <table class="table mt-4" method="GET" action="/usuarios">
            ...
            <tbody>
              ...
              <tr>
                ...
                @csrf
                @method('delete')
                  <button onclick="confirmDelete()" type="submit" class="btn btn-ligth" data-toggle="modal"  data-target="#agent{{$producto->idPro}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
