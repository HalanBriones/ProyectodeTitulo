        ...
        <table class="table mt-4" method="GET" action="/usuarios">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <a class="btn btn-light" onclick="delete_conocimiento({{$conocimiento->idconocimiento_servicio}})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
