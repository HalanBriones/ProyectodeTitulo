...
<main>
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Registro Marcas') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('marca.store')}}">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    <input id="marca" type="text" class="form-control has-feedback-left @error('pass_conf') is-invalid @enderror" name="marca" required >
                                    @error('marca')
