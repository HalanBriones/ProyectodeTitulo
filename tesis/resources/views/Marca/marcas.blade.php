        ...
        <table class="table mt-4" method="GET">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a  class="btn btn-dark" href="{{route('marca.edit',$marca->idMac)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
